...
const bnbData = async () => {
	const response = await fetch(
		"https://min-api.cryptocompare.com/data/v2/histominute?fsym=BNB&tsym=USD&limit=119&api_key=0646cc7b8a4d4b54926c74e0b20253b57fd4ee406df79b3d57d5439874960146"
	);
...
async function printBnbChart() {
	...
	gradient.addColorStop(0.75, "rgba(243, 186, 47,0)");
